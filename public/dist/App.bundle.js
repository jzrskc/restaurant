...
function makeMap(mapDiv) {
  ...
  // make our map
  var map = new google.maps.Map(mapDiv, mapOptions); // map created
  loadPlaces(map);
...
// DOM-only, na ovaj nacin stitimo, ako recimo neko ubaci <img> u naslov i stavi alert,
...
function typeAhead(search) {
  ...
  searchInput.addEventListener('keyup', function (e) {
    ...
    var activeClass = 'search__result--active'; // tamnija bg za active
    var current = search.querySelector('.' + activeClass);
    var items = search.querySelectorAll('.search__result'); // svi rezultati
    var next = void 0;
    // if press down
